...
export const ITEMS = {
  wood: { name: 'Bois', maxStack: 20, icon: '🪵' },
  stone: { name: 'Pierre', maxStack: 20, icon: '🪨' },
  meat: { name: 'Viande', maxStack: 10, icon: '🥩' },
  ...
  hache_bois: { name: 'Hache en bois', maxStack: 1, slot: 'weapon', damageBonus: 10, icon: '🪓' },
}
